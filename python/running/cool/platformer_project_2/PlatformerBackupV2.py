...
while True: # game loop
    ...
    if collisions['top']:
        ...
        for x in range(0,10):
            #print(player_rect.x)
            posit = (player_rect.x - scroll[0] + random.randint(-3,3), player_rect.y - scroll[1] + random.randint(-3,3))
            particle = Particle(posit, random.randint(0,6), scroll)
    ...
    for par in particles: 
        ...
        pygame.draw.circle(display, (255,255,255), renderpos, par.lifetime * 1, 0)
